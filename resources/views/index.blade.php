...
<div class="container">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="header_top">
          ...
          <div class="header_top_right">
            <p>Friday, Enero 22, 2020</p>
          </div>
        </div>
      </div>
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="header_bottom">
          <div class="logo_area"><a href="index.html" class="logo"><img src="{{ asset('images/logo1.jpg') }}" alt=""></a></div>
          <div class="add_banner"><a href="#"><img src="{{ asset('images/addbanner_728x90_V2.jpg') }}" alt=""></a></div>
        </div>
      </div>
    </div>
  </header>
      ...
      <div class="col-lg-12 col-md-12">
        <div class="latest_newsarea"> <span>Ultimas Titulars</span>
          <ul id="ticker01" class="news_sticker">
            ...
            <li><a href="#"><img src="{{asset ('images/news_thumbnail3.jpg') }}" alt="">Tercera Titulars</a></li>
            <li><a href="#"><img src="{{asset ('images/news_thumbnail3.jpg') }}" alt="">Cuarta Titulars</a></li>
            <li><a href="#"><img src="{{asset ('images/news_thumbnail3.jpg') }}" alt="">Quinta Titulars</a></li>
            <li><a href="#"><img src="{{asset ('images/news_thumbnail3.jpg') }}" alt="">Sexta Titulars</a></li>
            <li><a href="#"><img src="{{asset ('images/news_thumbnail3.jpg') }}" alt="">Setima Titulars</a></li>
            <li><a href="#"><img src="{{asset ('images/news_thumbnail3.jpg') }}" alt="">Octava Titulars</a></li>
            <li><a href="#"><img src="{{asset ('images/news_thumbnail2.jpg') }}" alt="">Novena Titulars</a></li>
          </ul>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam"> <a href="pages/single_page.html"> <img src="assets/images/belen.png" alt=""></a>
          ...
          <div class="single_iteam"> <a href="pages/single_page.html"> <img src="assets/images/oviyuli.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="pages/single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
            </div>
          </div>
          <div class="single_iteam"> <a href="pages/single_page.html"> <img src="assets/images/añoviejo.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="pages/single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
            </div>
          </div>
          <div class="single_iteam"> <a href="pages/single_page.html"> <img src="assets/images/artegrafica.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="pages/single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
            </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          ...
          <div class="single_sidebar">
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane" id="video">
                <div class="vide_area">
                    <iframe width="350" height="215" src="https://www.youtube.com/embed/z1V_Z5MmQEo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
              </div>
          ...
          <div class="single_sidebar wow fadeInDown">
            <h2><span>Categorias Archivos</span></h2>
  ...
  <footer id="footer">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="footer_widget wow fadeInRightBig">
            <h2>Contact</h2>
            <p>Somos una comunidad sin animo de lucro</p>
            <address>
    ...
    <div class="footer_bottom">
      <p class="copyright">Copyright &copy; 2020 <a href="index.html">Comunidad Santo Cristo</a></p>
