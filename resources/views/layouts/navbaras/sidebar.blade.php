<aside class="right_content">
    <div class="single_sidebar">
        ...
        <ul class="spost_nav">
            ...
            <li>
                <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt=""
                            src="../images/post_img1.jpg""> </a>
                    <div class="media-body"> <a href="single_page.html" class="catg_title">Nuevo</a>
                    </div>
                </div>
            </li>
    ...
    <div class="single_sidebar">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#video" aria-controls="profile" role="tab" data-toggle="tab">Videos</a>
            </li>
            ...
            <div role="tabpanel" class="tab-pane" id="comments">
                <ul class="spost_nav">
                    <li>
                        <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt=""
                                    src="../images/post_img1.jpg"> </a>
                            <div class="media-body"> <a href="single_page.html" class="catg_title"> Aliquam malesuada
