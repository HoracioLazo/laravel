        ...
        <div class="left_content">
          <div class="single_page">
            ...
            <div class="related_post">
              <h2>Post pruebas <i class="fa fa-thumbs-o-up"></i></h2>
              @foreach ($posts as $post)
              <ul class="spost_nav wow fadeInDown animated">


                  <li>
                    <div class="media"> <a class="media-left" href="single_page.html"> <img src="{{ Storage::url( $post->image->url ) }}" alt=""> </a>

                      <div class="media-body"> <a class="catg_title" href="single_page.html"> {{ $post->name }}</a> </div>
                    </div>
                  </li>
        ...
        <aside class="right_content">
            <div class="single_sidebar">
              ...
              <ul class="spost_nav">
                ...
                <li>
                  <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt="" src="{{ Storage::url( $post->image->url ) }}"> </a>
                    <div class="media-body"> <a href="single_page.html" class="catg_title"></a> {{ $post->name }}</div>
                  </div>
                </li>
